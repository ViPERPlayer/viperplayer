...
/**
 * "For You" screen: a taste-based mix from the local library. Renders the shared [RecommendationsScreen]
 * and wires the per-song options sheet — all logic lives in [ForYouViewModel].
 */
@Composable
fun ForYouScreen(
    ...
    RecommendationsScreen(
        state = uiState.copy(title = stringResource(R.string.rec_for_you_title)),
